...
If you do not have go, we recommend installing it:
...
The `did-sdk` build is run by Mage.
...
Design discussions and proposals take place on GitHub Discussions. We advocate an asynchronous, written debate model - so write up your thoughts and invite the community to join in!

### Continuous Integration

Build and Test cycles are run on every commit to every branch on [CircleCI](https://app.circleci.com/pipelines/github/TBD54566975/did-sdk?filter=all).
...
* Start by proposing a change either in Issues (most appropriate for small change requests or bug fixes) or in Discussions (most appropriate for design and architecure considerations, proposing a new feature, or where you'd like insight and feedback)
...
* Fork the repo into your own namesapce/remote

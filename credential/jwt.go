...
// object is returned.
func VerifyVerifiablePresentationJWT(ctx context.Context, verifier jwx.Verifier, resolver resolver.Resolver, token string) (jws.Headers, jwt.Token, *VerifiablePresentation, error) {
	if resolver == nil {
